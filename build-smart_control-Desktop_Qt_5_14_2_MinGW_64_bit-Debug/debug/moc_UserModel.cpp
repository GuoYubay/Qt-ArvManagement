...
#include <memory>
#include "../../smart_control/Model/UserModel.h"
...
QT_MOC_LITERAL(1, 10, 11), // "soleChanged"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 7), // "CurUser"
QT_MOC_LITERAL(4, 31, 7) // "CurRole"

    },
    "UserModel\0soleChanged\0\0CurUser\0CurRole"
};
...
void UserModel::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&UserModel::soleChanged)) {
                *result = 0;
                return;
            }
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< QString*>(_v) = _t->curuser(); break;
        case 1: *reinterpret_cast< QString*>(_v) = _t->cursole(); break;
        default: break;
        }
        ...
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setcuruser(*reinterpret_cast< QString*>(_v)); break;
        default: break;
        }
