...
QtObject {
    ...
    property string imagePathPrefix: "qrc:/Icon/"
    ...
    property color controlBorderColor_hovered: Qt.darker(themeColor, 1.8)
    property color controlBorderColor_pressed: Qt.darker(themeColor, 3)

    property color controlColor:Qt.darker(themeColor, 2)
